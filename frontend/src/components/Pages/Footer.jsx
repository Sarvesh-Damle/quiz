...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 bg-gray-200 pt-20 pb-10 lg:pt-[120px] lg:pb-20">
        <div className="container">
          <div className="flex flex-wrap -mx-4 justify-around">
            ...
            <LinkGroup header="Company">
              ...
              <NavLink link="https://3-d-portfolio-website-sarvesh-damle.vercel.app/" label="About" />
            </LinkGroup>
              ...
              <div className="w-full mb-10">
                ...
                <div className="flex items-center mb-6">
                  ...
                  <a
                    ...
                    className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] text-dark hover:border-primary hover:bg-primary hover:text-red-500 sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width={16}
                      height={12}
